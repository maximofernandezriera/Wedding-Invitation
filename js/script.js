...
var countDownDate = new Date("Dic 31, 2021 00:00:00").getTime();
...
var x = setInterval(function() {
    ...
    document.getElementById("time").innerHTML = "<div class='container'><div class='days block'>"+ days + "<br><Días</div>" + "<div class='hours block'>" + hours + "<br>Horas</div>" + "<div class='minutes block'>" + minutes + "<br>Minutos</div>" + "<div class='seconds block'>" + seconds + "<br>Segundos</div></div>";
    
    // If the count down is over, write some text 
    if (distance < 0) {
        clearInterval(x);
        document.getElementById("time").innerHTML = "Entre las dos elegirmos tu look perfecto de novia o invitada.";
    }
}, 1000);
